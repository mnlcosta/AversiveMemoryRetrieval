...
cd ~/data2github/
load 'datapowconds_encrec_amy.mat'
addpath('~/githubcodes/utils/reinstatement-analysis-master/additional_functions')

%%
subjects=[60 13 15 160 25 32 33 600 2000 2 4 210 36 27 34 38 8];%n=17
...
tit=title(['emotion by memory ; pval=' num2str(statERSint.negclusters(1).prob, '%0.3f')]);set(findobj(tit,'type','text'),'FontSize',10);
...
subplot(2,3,6)
addpath('~/githubcodes/utils/beeswarm-master')
addpath('~/githubcodes/utils/stdshade.m')
